...
export interface ChatMessage {
  ...
  /** Office files the create_document tool produced during this reply, kept so the
   *  split-screen preview can be reopened by clicking the message after a relaunch. */
  documents?: DocumentRef[]
}

/** A document generated by the create_document tool, stored on its assistant
 *  message so its split-screen preview survives app restarts. */
